...
desc 'Generate documentation for the up_cross_sell extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'UpCrossSellExtension'
...
desc 'Test the up_cross_sell extension.'
...
namespace :test do
  desc 'Functional test the up_cross_sell extension.'
  ...
  desc 'Unit test the up_cross_sell extension.'
